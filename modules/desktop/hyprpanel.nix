  ...
  "2" = {
    ...
    right = [
      ...
      "notifications"
        ...
        theme.bar.menus.menu.power.buttons.sleep.background = lib.mkForce "#282828";
        ...
        theme.bar.menus.menu.power.buttons.logout.background = lib.mkForce "#282828";
        ...
        theme.bar.menus.menu.power.buttons.restart.background = lib.mkForce "#282828";
        ...
        theme.bar.menus.menu.power.buttons.shutdown.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.power.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.power.icon = "#cc241d";
        theme.bar.buttons.modules.power.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.weather.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.weather.icon = "#fe8017";
        theme.bar.buttons.modules.weather.text = "#fe8017";
        theme.bar.buttons.modules.weather.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.updates.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.updates.icon = "#b16286";
        theme.bar.buttons.modules.updates.text = "#b16286";
        theme.bar.buttons.modules.updates.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.kbLayout.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.kbLayout.icon = "#83a598";
        theme.bar.buttons.modules.kbLayout.text = "#83a598";
        theme.bar.buttons.modules.kbLayout.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.netstat.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.netstat.icon = "#b8bb26";
        theme.bar.buttons.modules.netstat.text = "#b8bb26";
        theme.bar.buttons.modules.netstat.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.storage.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.storage.icon = "#83a598";
        theme.bar.buttons.modules.storage.text = "#83a598";
        theme.bar.buttons.modules.storage.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.cpu.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.cpu.icon = "#d3869b";
        theme.bar.buttons.modules.cpu.text = "#d3869b";
        theme.bar.buttons.modules.cpu.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.ram.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.ram.icon = "#fabd2f";
        theme.bar.buttons.modules.ram.text = "#fabd2f";
        theme.bar.buttons.modules.ram.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.battery.background = lib.mkForce "#282828";
        theme.bar.buttons.systray.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.bluetooth.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.windowtitle.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.workspaces.background = lib.mkForce "#282828";
        theme.bar.buttons.dashboard.icon = "#fabd2f";
        theme.bar.buttons.dashboard.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.submap.background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.submap.icon_background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.hyprsunset.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.hyprsunset.icon_background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.hypridle.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.hypridle.icon_background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.cava.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.cava.icon_background = lib.mkForce "#282828";
        ...
        theme.bar.buttons.modules.microphone.background = lib.mkForce "#282828";
        theme.bar.buttons.modules.microphone.text = "#b8bb26";
        theme.bar.buttons.modules.microphone.icon = "#b8bb26";
        theme.bar.buttons.modules.microphone.icon_background = lib.mkForce "#282828";
        theme.bar.buttons.modules.worldclock.text = "#d3869b";
        theme.bar.buttons.modules.worldclock.background = lib.mkForce "#282828";
